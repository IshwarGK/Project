...
var speed = [];
    ...
    var validity_len = $("input[name='validity']:checked").length;
            ...
            var url = "internet_plan.php?brand=" + favorite.join(", ") + "& plan=" + plan.join(", ") + "& speed=" + speed.join(", ") + "& price=" + price.join(", ") + "& validity=" + validity.join(", ") + "& count1=" + brand_len + "& count2=" + plan_len + "& count3=" + speed_len + "& count4=" + price_len + "& count5=" + validity_len + "& Plan_test_name=airtel_plan" ;
