			...
			jQuery("document").ready(function($){
				...
				$(window).scroll(function () {
					...
					if ($(this).scrollTop() > pos) {
						$('#slogan').hide(1000);
						$('#search-toggle').animate({marginTop:"13px"}, -20000000);
						$('#menu1').hide(500);
						$('.header-menubar').hide("slow");
     				} else {
						$('#search-toggle').animate({marginTop:"0px"}, -20000000);
						$('#slogan').show(1000);
						$('#menu1').show(500);
						$('.header-menubar').show("slow");	
     				}
				});
			});
			//second method
        	...
        	<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-11">
							<form role="form">
								<div class="input-group form-group" id="search-toggle" style="width:651px;">
